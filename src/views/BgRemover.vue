...
watch(model, () => {
  if (image.value && (status.value === 'done' || status.value === 'error')) {
    processImage()
  }
})
    ...
    <div class="max-w-5xl mx-auto space-y-6">
      ...
      <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 class="text-sm font-semibold text-slate-800 uppercase tracking-wide mb-3">AI model</h2>
      ...
      <div class="space-y-6">
        ...
        >
          <div class="max-w-md mx-auto text-center">
            ...
            <p class="mt-1 text-sm text-slate-500 truncate">{{ progressStage }}</p>
